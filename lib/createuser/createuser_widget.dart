...
class _CreateuserWidgetState extends State<CreateuserWidget> {
  ...
  void initState() {
    ...
    _model.currentBeltTextController ??= TextEditingController();
    _model.currentBeltFocusNode ??= FocusNode();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.currentBeltTextController,
                          focusNode: _model.currentBeltFocusNode,
                          autofocus: false,
                          obscureText: false,
                          decoration: InputDecoration(
                            isDense: false,
                            hintText: 'Current Belt',
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
                          ...
                          cursorColor: FlutterFlowTheme.of(context).primaryText,
                          validator: _model.currentBeltTextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                    ],
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller:
                              _model.alertnativeContactNumberTextController,
                          focusNode: _model.alertnativeContactNumberFocusNode,
                          autofocus: false,
                          autofillHints: [AutofillHints.telephoneNumber],
                          obscureText: false,
                          decoration: InputDecoration(
                            isDense: false,
                            hintText: 'Alertnative Contact Number',
                            hintStyle: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        _model.apiResult6c8 = await CreateUserCall.call(
                          firstName: _model.firstNameTextController.text,
                          middleName: _model.middleNameTextController.text,
                          lastName: _model.lastNameTextController.text,
                          currentBelt: _model.currentBeltTextController.text,
                          emailID: _model.emailIDTextController.text,
                        ...
                        if ((_model.apiResult6c8?.succeeded ?? true)) {
                          await showDialog(
                            context: context,
                          ...
                          context.pushNamed(
                            UseraddattendanceWidget.routeName,
