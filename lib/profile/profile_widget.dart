...
class _ProfileWidgetState extends State<ProfileWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.apiResult4hn = await DetailsGroup.getuserHFTACall.call(
        username: FFAppState().Username,
      );

      if ((_model.apiResult4hn?.succeeded ?? true)) {
        FFAppState().gender = getJsonField(
          (_model.apiResult4hn?.jsonBody ?? ''),
          r'''$.Gender''',
        ).toString().toString();
        safeSetState(() {});
        FFAppState().profiledetails =
            (_model.apiResult4hn?.jsonBody ?? '').toString();
        safeSetState(() {});
      } else {
        await showDialog(
          context: context,
                        ...
                        child: Image.network(
                          () {
                            if (FFAppState().gender == 'Male') {
                              return 'https://e1.pxfuel.com/desktop-wallpaper/1014/922/desktop-wallpaper-emojivip-memoji-boy.jpg';
                            } else if (FFAppState().gender == 'Female') {
                              return 'https://wallpapers.com/images/high/emoji-girl-idcjlbhbcozagm2v.webp';
                            } else {
                              return 'No Image';
                            }
                          }(),
                            ...
                            Expanded(
                              child: TextFormField(
                                ...
                                cursorColor:
                                    FlutterFlowTheme.of(context).primaryText,
                                validator: _model
                                    .currentBeltTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ],
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: TextFormField(
                                controller: _model
                                    .alertnativeContactNumberTextController,
                                focusNode:
                                    _model.alertnativeContactNumberFocusNode,
                                autofocus: false,
                                autofillHints: [AutofillHints.telephoneNumber],
                                readOnly: true,
                                obscureText: false,
